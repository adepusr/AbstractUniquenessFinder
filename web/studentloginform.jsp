						...
						<div class="row">
							<div class="12u">
								<section class="box box-style1">
									<form method="post" action="StudentloginActionServlet">
									<div>
										<div class="row half">
                                                                                    <%
...
%>
											<div class="7u">
												<input type="text" name="sid" id="name" placeholder="Enter Hallticket To Login" />
											</div>
                                                                                    <br>
											<div class="7u" style="margin-top: 50px;">
												<input type="password" name="spsw" id="email" placeholder="Enter Password" />
											</div>
										</div>
